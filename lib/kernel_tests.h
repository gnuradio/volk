...
std::vector<volk_test_case_t> init_test_list(volk_test_params_t test_params)
{
    ...
    std::vector<volk_test_case_t> test_cases = boost::assign::list_of
        ...
        (VOLK_INIT_TEST(volk_32fc_index_max_16u,      volk_test_params_t(0, test_params.scalar(), test_params.vlen(), test_params.iter(), test_params.benchmark_mode(), test_params.kernel_regex())))
        (VOLK_INIT_TEST(volk_32fc_index_max_32u,      volk_test_params_t(0, test_params.scalar(), test_params.vlen(), test_params.iter(), test_params.benchmark_mode(), test_params.kernel_regex())))

...
std::vector<volk_test_case_t> init_test_list(volk_test_params_t test_params)
{
    ...
    QA(VOLK_INIT_TEST(volk_8i_x2_saturated_sum_8i, test_params))
    QA(VOLK_INIT_TEST(volk_8u_x2_saturated_sum_8u, test_params))
    QA(VOLK_INIT_TEST(volk_16i_x2_saturated_sum_16i, test_params))
    QA(VOLK_INIT_TEST(volk_16u_x2_saturated_sum_16u, test_params))

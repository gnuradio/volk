...
std::vector<volk_test_case_t> init_test_list(volk_test_params_t test_params)
{
    ...
    std::vector<volk_test_case_t> test_cases = boost::assign::list_of
        ...
        (VOLK_INIT_TEST(volk_32f_index_max_32u,                         test_params))        (VOLK_INIT_TEST(volk_32f_x2_pow_32f,         volk_test_params_t(1e-2, test_params.scalar(), test_params.vlen(), test_params.iter(), test_params.benchmark_mode(), test_params.kernel_regex())))

...
/*!
 * \page volk_16i_x2_saturated_sum_16i
 *
 * \b Overview
 *
 ...
 * \code
 * void volk_16i_x2_saturated_sum_16i(int16_t* outVector, const int16_t* inVectorA, const
 ...
 *
 *   volk_16i_x2_saturated_sum_16i(result, a, b, N);
...
#ifndef INCLUDED_volk_16i_x2_saturated_sum_16i_u_H
#define INCLUDED_volk_16i_x2_saturated_sum_16i_u_H

#include <inttypes.h>

#ifdef LV_HAVE_GENERIC

static inline void volk_16i_x2_saturated_sum_16i_generic(int16_t* outVector,
                                                         const int16_t* inVectorA,
                                                         const int16_t* inVectorB,
                                                         unsigned int num_points)
{
    for (unsigned int i = 0; i < num_points; i++) {
        int32_t sum = (int32_t)inVectorA[i] + (int32_t)inVectorB[i];
        if (sum > 32767)
            sum = 32767;
        else if (sum < -32768)
            sum = -32768;
        outVector[i] = (int16_t)sum;
    }
}
...
static inline void volk_16i_x2_saturated_sum_16i_u_sse2(int16_t* outVector,
                                                        const int16_t* inVectorA,
                                                        const int16_t* inVectorB,
                                                        unsigned int num_points)
{
...
static inline void volk_16i_x2_saturated_sum_16i_u_avx2(int16_t* outVector,
                                                        const int16_t* inVectorA,
                                                        const int16_t* inVectorB,
                                                        unsigned int num_points)
{
...
static inline void volk_16i_x2_saturated_sum_16i_u_avx512bw(int16_t* outVector,
                                                            const int16_t* inVectorA,
                                                            const int16_t* inVectorB,
                                                            unsigned int num_points)
{
...
#endif /* INCLUDED_volk_16i_x2_saturated_sum_16i_u_H */


#ifndef INCLUDED_volk_16i_x2_saturated_sum_16i_a_H
#define INCLUDED_volk_16i_x2_saturated_sum_16i_a_H
...
static inline void volk_16i_x2_saturated_sum_16i_a_sse2(int16_t* outVector,
                                                        const int16_t* inVectorA,
                                                        const int16_t* inVectorB,
                                                        unsigned int num_points)
{
...
static inline void volk_16i_x2_saturated_sum_16i_a_avx2(int16_t* outVector,
                                                        const int16_t* inVectorA,
                                                        const int16_t* inVectorB,
                                                        unsigned int num_points)
{
...
static inline void volk_16i_x2_saturated_sum_16i_a_avx512bw(int16_t* outVector,
                                                            const int16_t* inVectorA,
                                                            const int16_t* inVectorB,
                                                            unsigned int num_points)
{
...
static inline void volk_16i_x2_saturated_sum_16i_neon(int16_t* outVector,
                                                      const int16_t* inVectorA,
                                                      const int16_t* inVectorB,
                                                      unsigned int num_points)
{
...
static inline void volk_16i_x2_saturated_sum_16i_neonv8(int16_t* outVector,
                                                        const int16_t* inVectorA,
                                                        const int16_t* inVectorB,
                                                        unsigned int num_points)
{
...
static inline void volk_16i_x2_saturated_sum_16i_rvv(int16_t* outVector,
                                                     const int16_t* inVectorA,
                                                     const int16_t* inVectorB,
                                                     unsigned int num_points)
{
...
#endif /* INCLUDED_volk_16i_x2_saturated_sum_16i_a_H */

 ...
 * \code
 * void volk_8i_x2_saturated_sum_8i(int8_t* outVector, const int8_t* inVectorA, const
 ...
 *
 *   volk_8i_x2_saturated_sum_8i(result, a, b, N);
...
static inline void volk_8i_x2_saturated_sum_8i_generic(int8_t* outVector,
                                                       const int8_t* inVectorA,
                                                       const int8_t* inVectorB,
                                                       unsigned int num_points)
{
    for (unsigned int i = 0; i < num_points; i++) {
        int16_t sum = (int16_t)inVectorA[i] + (int16_t)inVectorB[i];
        if (sum > 127)
            sum = 127;
        else if (sum < -128)
            sum = -128;
        outVector[i] = (int8_t)sum;
    }
}
...
static inline void volk_8i_x2_saturated_sum_8i_u_sse2(int8_t* outVector,
                                                      const int8_t* inVectorA,
                                                      const int8_t* inVectorB,
                                                      unsigned int num_points)
{
...
static inline void volk_8i_x2_saturated_sum_8i_u_avx2(int8_t* outVector,
                                                      const int8_t* inVectorA,
                                                      const int8_t* inVectorB,
                                                      unsigned int num_points)
{
...
static inline void volk_8i_x2_saturated_sum_8i_u_avx512bw(int8_t* outVector,
                                                          const int8_t* inVectorA,
                                                          const int8_t* inVectorB,
                                                          unsigned int num_points)
{
...
#endif /* INCLUDED_volk_8i_x2_saturated_sum_8i_u_H */
...
static inline void volk_8i_x2_saturated_sum_8i_a_sse2(int8_t* outVector,
                                                      const int8_t* inVectorA,
                                                      const int8_t* inVectorB,
                                                      unsigned int num_points)
{
...
static inline void volk_8i_x2_saturated_sum_8i_a_avx2(int8_t* outVector,
                                                      const int8_t* inVectorA,
                                                      const int8_t* inVectorB,
                                                      unsigned int num_points)
{
...
static inline void volk_8i_x2_saturated_sum_8i_a_avx512bw(int8_t* outVector,
                                                          const int8_t* inVectorA,
                                                          const int8_t* inVectorB,
                                                          unsigned int num_points)
{
...
static inline void volk_8i_x2_saturated_sum_8i_neon(int8_t* outVector,
                                                    const int8_t* inVectorA,
                                                    const int8_t* inVectorB,
                                                    unsigned int num_points)
{
...
static inline void volk_8i_x2_saturated_sum_8i_neonv8(int8_t* outVector,
                                                      const int8_t* inVectorA,
                                                      const int8_t* inVectorB,
                                                      unsigned int num_points)
{
...
static inline void volk_8i_x2_saturated_sum_8i_rvv(int8_t* outVector,
                                                   const int8_t* inVectorA,
                                                   const int8_t* inVectorB,
                                                   unsigned int num_points)
{
...
#endif /* INCLUDED_volk_8i_x2_saturated_sum_8i_a_H */

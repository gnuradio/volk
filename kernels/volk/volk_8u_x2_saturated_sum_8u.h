...
/*!
 * \page volk_8u_x2_saturated_sum_8u
 *
 * \b Overview
 *
 ...
 * \code
 * void volk_8u_x2_saturated_sum_8u(uint8_t* outVector, const uint8_t* inVectorA, const
 ...
 *
 *   volk_8u_x2_saturated_sum_8u(result, a, b, N);
...
#ifndef INCLUDED_volk_8u_x2_saturated_sum_8u_u_H
#define INCLUDED_volk_8u_x2_saturated_sum_8u_u_H

#include <inttypes.h>

#ifdef LV_HAVE_GENERIC

static inline void volk_8u_x2_saturated_sum_8u_generic(uint8_t* outVector,
                                                       const uint8_t* inVectorA,
                                                       const uint8_t* inVectorB,
                                                       unsigned int num_points)
{
    for (unsigned int i = 0; i < num_points; i++) {
        uint16_t sum = (uint16_t)inVectorA[i] + (uint16_t)inVectorB[i];
        if (sum > 255)
            sum = 255;
        outVector[i] = (uint8_t)sum;
    }
}
...
static inline void volk_8u_x2_saturated_sum_8u_u_sse2(uint8_t* outVector,
                                                      const uint8_t* inVectorA,
                                                      const uint8_t* inVectorB,
                                                      unsigned int num_points)
{
...
static inline void volk_8u_x2_saturated_sum_8u_u_avx2(uint8_t* outVector,
                                                      const uint8_t* inVectorA,
                                                      const uint8_t* inVectorB,
                                                      unsigned int num_points)
{
...
static inline void volk_8u_x2_saturated_sum_8u_u_avx512bw(uint8_t* outVector,
                                                          const uint8_t* inVectorA,
                                                          const uint8_t* inVectorB,
                                                          unsigned int num_points)
{
...
#endif /* INCLUDED_volk_8u_x2_saturated_sum_8u_u_H */


#ifndef INCLUDED_volk_8u_x2_saturated_sum_8u_a_H
#define INCLUDED_volk_8u_x2_saturated_sum_8u_a_H
...
static inline void volk_8u_x2_saturated_sum_8u_a_sse2(uint8_t* outVector,
                                                      const uint8_t* inVectorA,
                                                      const uint8_t* inVectorB,
                                                      unsigned int num_points)
{
...
static inline void volk_8u_x2_saturated_sum_8u_a_avx2(uint8_t* outVector,
                                                      const uint8_t* inVectorA,
                                                      const uint8_t* inVectorB,
                                                      unsigned int num_points)
{
...
static inline void volk_8u_x2_saturated_sum_8u_a_avx512bw(uint8_t* outVector,
                                                          const uint8_t* inVectorA,
                                                          const uint8_t* inVectorB,
                                                          unsigned int num_points)
{
...
static inline void volk_8u_x2_saturated_sum_8u_neon(uint8_t* outVector,
                                                    const uint8_t* inVectorA,
                                                    const uint8_t* inVectorB,
                                                    unsigned int num_points)
{
...
static inline void volk_8u_x2_saturated_sum_8u_neonv8(uint8_t* outVector,
                                                      const uint8_t* inVectorA,
                                                      const uint8_t* inVectorB,
                                                      unsigned int num_points)
{
...
static inline void volk_8u_x2_saturated_sum_8u_rvv(uint8_t* outVector,
                                                   const uint8_t* inVectorA,
                                                   const uint8_t* inVectorB,
                                                   unsigned int num_points)
{
...
#endif /* INCLUDED_volk_8u_x2_saturated_sum_8u_a_H */
